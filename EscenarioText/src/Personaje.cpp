...
void Personaje::Rotate(float ang,float x,float y,float z)
{
    col.Rotate(ang,x,y,z);
}

void Personaje::Translate(float x,float y,float z)
{
    col.Translate(x,y,z);
}

void Personaje::Scale(float s)
{
    col.Scale(s);
}

bool Personaje::Choque(float x,float z,float rad)
{
...
void Personaje::update(int bandera)
{
    if(bandera==0)
    {
